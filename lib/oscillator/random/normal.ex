defmodule Oscillator.Random.Normal do

  use GenOscillator, Oscillator.Random.Normal
  ...
  defmodule AmplitudeHandler do
    ...
    def handle_event(input, {pid}) do
      Oscillator.Random.Normal.set(pid, {:amplitude, input})
      {:ok, {pid}}
    end
  end
  ...
  defmodule FrequencyHandler do
    ...
    def handle_event(input, {pid}) do
      Oscillator.Random.Normal.set(pid, {:frequency, input})
      {:ok, {pid}}
    end
  end
